...
<body>
	<div data-role="page" id="login">
		...
		<div data-role="content">
			帐号信息:
			<form:form id="formBusinessLogin" modelAttribute="OM" action="/doume/customer/login" method="POST">
				<div>
					<label for="userName">用户帐号：</label>
					<form:input id="userName" path="userName" value="PaoDing" pattern="[A-Za-z0-9_.]{4,31}" type="text" maxlength="30"></form:input>
			...
			<div>
				<a href="/doume/customer/getRegister" data-role="button">Register</a>
			</div>
		</div>
	</div>
</body>
